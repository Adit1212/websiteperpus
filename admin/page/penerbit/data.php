	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				Data penerbit <span class="pull-right"><a href="javascript:void(0)" onclick="tambah()" class="btn btn-primary btn-xs">Tambah penerbit</a></span>
			</div>
			<div class="panel-body table-responsive">
	         <table class="table table-bordered table-hover example">
	           	<thead>
					...
					<tbody>
						<?php $sql= $go->datapenerbit($con);
						$no= 1; while($data= mysqli_fetch_array($sql)){ ?>
						<tr>
							<td><?php echo $no; ?></td>
							<td><?php echo $data['nama_penerbit']; ?></td>
							<td>
								<a href="javascript:void(0)" onclick="edit('<?php echo $data['id_penerbit']; ?>')" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
								<a href="javascript:void(0)" onclick="hapus('<?php echo $data['id_penerbit']; ?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
							</td>
						</tr>
						<?php $no++; } ?>
					</tbody>
...
<script>
	function	tambah(){
		$.ajax({
			type : "GET",
			url : "<?php echo $base_url.'admin/page/penerbit/tambah.php'; ?>",
			cache : false,
	...
	function	edit(id){
		$.ajax({
			type : "GET",
			url : "<?php echo $base_url.'admin/page/penerbit/edit.php?id_penerbit='; ?>"+id,
			cache : false,
	...
	function hapus(id){
		...
		.then(function () {
        	$.ajax({
				type : "GET",
				url : "<?php echo $base_url.'admin/control.php?pos=hapuspenerbit&nama_penerbit='; ?>"+id,
				cache : false,
