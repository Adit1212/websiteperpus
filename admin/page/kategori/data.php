	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				Data kategori <span class="pull-right"><a href="javascript:void(0)" onclick="tambah()" class="btn btn-primary btn-xs">Tambah kategori</a></span>
			</div>
	           	...
	           	<thead>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="javascript:void(0)" onclick="edit('<?php echo $data['id_kategori']; ?>')" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
								<a href="javascript:void(0)" onclick="hapus('<?php echo $data['id_kategori']; ?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>								
							</td>
						</tr>
						<?php $no++; } ?>
					</tbody>
...
<script>
	function	tambah(){
		$.ajax({
			type : "GET",
			url : "<?php echo $base_url.'admin/page/kategori/tambah.php'; ?>",
			cache : false,
	...
	function	edit(id){
		$.ajax({
			type : "GET",
			url : "<?php echo $base_url.'admin/page/kategori/edit.php?id_kategori='; ?>"+id,
			cache : false,
	...
	function hapus(id){
		...
		.then(function () {
        	$.ajax({
				type : "GET",
				url : "<?php echo $base_url.'admin/control.php?pos=hapuskategori&kategori='; ?>"+id,
				cache : false,
