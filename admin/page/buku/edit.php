...
<div class="modal fade" id="modedit">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo $base_url.'admin/control.php?pos=editbuku'; ?>">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select name="id_rakbuku_buku" class="form-control">
                        ...
                        while($drak= mysqli_fetch_array($rakbuku)){
                            if($data['id_rakbuku_buku']==$drak['id_rakbuku']){ $selrak= 'selected'; }else { $selrak= ''; }
                            echo '<option '.$selrak.' value="'.$drak['id_rakbuku'].'">'.$drak['nama_rakbuku'].'</option>';
                        } ?>
                    </select>
                </div>
                <div class="form-group">
                    <label>Nama Buku</label>
                    <input type="text" name="nama_buku" class="form-control" value="<?php echo $data['nama_buku']; ?>">
                     </div>
                <div class="form-group">
                    <label>Kode Klasifikasi</label>
                    <input type="text" name="klasifikasi_buku" class="form-control" value="<?php echo $data['klasifikasi_buku']; ?>">
                </div>
                <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tahun_buku" class="form-control" value="<?php echo $data['tahun_buku']; ?>">
                </div>
                <div class="form-group">
                    <label>Stok Buku</label>
                    <input type="number" name="stok_buku" class="form-control" value="<?php echo $data['stok_buku']; ?>">
                </div>
                <div class="form-group">
                    <label>Kategori Buku</label>
                    <select name="kategori" class="form-control">
                        <option value="<?php echo $data['id_kategori']; ?>"></option>
