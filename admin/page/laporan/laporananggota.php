		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form target="_blank" method="get" action="<?php echo $base_url.'admin/control.php'; ?>">
					<input type="hidden" name="pos" value="laporananggota">
					<div class="form-group">
						<select class="form-control" name="tipe">
							<option value="semua">Cetak Semua Anggota</option>
							<option value="seringpinjam">Cetak Semua Anggota Yang Sering Meminjam</option>
						</select>
					</div>
					<p>Dari</p>
					<div class="form-group">
