...
<html lang="en">
  ...
  <body style="background:url(<?php echo $base_url; ?>template/img/)
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" action="<?php echo $base_url.'home/control.php?pos=login'; ?>">
        <div class="panel panel-default">
          <div class="panel-heading">
             <center><img src="template/img/logosma.png" width="200px" height="200px"></center>
            <h5 class="text-center">LOGIN PERPUSTAKAAN</h5>
          </div>
          <div class="panel-body">
            ...
            <p>Belum punya akun? daftar <a href="<?php echo $base_url.'daftar.php'; ?>">disini</a></p>
          </div>
    ...
    <script type="text/javascript">
      $('#formlogin').submit(function(e){
        $.ajax({
          type : "post",
          url : "<?php echo $base_url.'home/control.php?pos=login'; ?>",
          ...
          success : function(response){
            ...
            else if(response=="anggota"){
              iziToast.show({timeout:3000,color:'green',title: 'Berhasil Login Anggota',position: 'topRight',pauseOnHover: true,transitionIn: false});
